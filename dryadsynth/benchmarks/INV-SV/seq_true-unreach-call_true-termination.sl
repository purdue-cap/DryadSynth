...
(define-fun TransF ((n0 Int) (n1 Int) (i0 Int) (k Int) (i1 Int) (j1 Int)
		(n0! Int) (n1! Int) (i0! Int) (k! Int) (i1! Int) (j1! Int)) Bool
   (or (and (< i0 n0) 
		(= i0! (+ i0 1))
		(= k! (+ k 1))
		(= n0! n0) (= n1! n1) (= i1! i1) (= j1! j1))
	(and (>= i0 n0) (< i1 n1)
		(= i1! (+ i1 1))
		(= k! (+ k 1))
		(= n0! n0) (= n1! n1) (= i0! i0) (= j1! j1))
	(and (>= i0 n0) (>= i1 n1) (< j1 (+ n0 n1))
		(= j1! (+ j1 1))
		(= k! (- k 1))
		(= n0! n0) (= n1! n1) (= i0! i0) (= i1! i1))
	))

(define-fun PostF ((n0 Int) (n1 Int) (i0 Int) (k Int) (i1 Int) (j1 Int)) Bool
   (or (< i0 n0) (< i1 n1) (< j1 (+ n0 n1)) (> k 0)))
