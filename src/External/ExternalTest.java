...
public class ExternalTest {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String solution_str = CLIA_max2_solution.toString();
        System.out.println(solution_str);
        DefinedFunc parsed_solution = ExternalSolver.decode(CLIA_max2_problem, solution_str)[0];
        System.out.println(parsed_solution.toString());

        solution_str = General_qm_max2_solution.toString();
        System.out.println(solution_str);
        parsed_solution = ExternalSolver.decode(General_qm_max2_problem, solution_str)[0];
        System.out.println(parsed_solution.toString());

        solution_str = INV_dec_solution.toString();
        System.out.println(solution_str);
        parsed_solution = ExternalSolver.decode(INV_dec_problem, solution_str)[0];
        System.out.println(parsed_solution.toString());
        System.out.println("==========Decode Test==========");
