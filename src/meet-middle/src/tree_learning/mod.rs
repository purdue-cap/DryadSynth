...
use bumpalo::Bump;
use crate::enumerate::expr::OwnedExpr as BvExpr;
...
impl<'a, 'b> TreeLearning<'a, 'b> {
    ...
    // }
    pub fn new_in(size: usize, conditions: &'b [(BvExpr, Bits)], options: Vec<(BvExpr, Bits)>, bump: &'a Bump, limit: usize) -> Self {
        let mut this = Self {
            size,
...
#[inline(always)]
pub fn tree_learning<'a, 'b>(options: Vec<(BvExpr, Bits)>, conditions: &'b [(BvExpr, Bits)], size: usize, bump: &'a Bump, limit: usize) -> TreeLearning<'a, 'b> {
