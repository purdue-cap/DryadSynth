...
(or (and (>= n (* 2 k)) (and (= k! k) (and (= b! b) (and (= i! i) (and (= j! j) (= n! n)))))) (or (and (< n (* 2 k)) (and (= b 1) (and (= k! k) (and (= b! 0) (and (= i! (+ i 1)) (and (= j! j) (= n! (+ n 1)))))))) (and (< n (* 2 k)) (and (= b 0) (and (= k! k) (and (= b! 1) (and (= i! i) (and (= j! (+ j 1)) (= n! (+ n 1)))))))))))
